...
const getMyItems = async () => {
	...
	for(i = 0; i < num; i++){
		...
		//NOTE  Update ABI
		_itemData.push({ id:itemData[i][0], title:metaData['title'], info:metaData['info'], cat:itemData[i][5], price:itemData[i][4], instock:((ownerInfo == Amazon_Contract_Address) ? true : false)});
